...
export const realSolarSystemData = {
    name: "Sun",
    color: 0xfdfbd3,
    albedo: 1,
    radius: 1392700 / 2,
...
export const toonSolarSystemData = {
    name: "Sun",
    color: 0xfdfbd3,
    albedo: 1,
    radius: 100000,
...
const normalizeBodyData = (body) => {
    ...
    body.orbit.rotationPeriod = body.orbit.rotationPeriod === 0 ? body.orbit.rotationPeriod : 1 / body.orbit.rotationPeriod;
